    ...
    >
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row w-10/12 lg:w-8/12 bg-white rounded-xl mx-auto shadow-lg overflow-hidden">
          <div
            className="w-full lg:w-1/2 flex flex-col items-center justify-center p-12 bg-[#d9a74a] "  
          >
            <img src={logoLogin} alt="Logo" className="mb-8" />
          </div>
          <div className="w-full lg:w-1/2 py-16 px-12 bg-[#e24545]">
            <h2 className="text-3xl mb-4 text-black text-center font-bold">
              Login
            </h2>
            <p className="mb-4 text-black text-center font-semibold">
              Login to your account Boss.
            </p>
            <form action="#">
              <div className="mt-5">
                <label className="mb-4 block text-black font-medium">
                  Email
                </label>
                <input
                  type="text"
              ...
              <div className="mt-5">
                <button
                  ...
                  className="w-full bg-[#d9a74a] py-3 text-center text-black border-0 rounded-md font-semibold"
                >
                  Login
                </button>
              </div>
